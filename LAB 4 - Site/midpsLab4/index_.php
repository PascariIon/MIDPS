...
//if($connection){ // echo "Yes, it is!"; //}
    ...
    while($row = mysqli_fetch_array($search_query)){
        ...
        echo "<div><img width='465' height='300' src='{$image}' alt=\"\">";
        echo "<h2>{$year}, {$brand}.</h2>";
        echo "<p>{$description}</p>";
        echo "<p style=\"text-align:right; margin-right: 16px\"> </p></div>";
    }
                ...
                <script>
                    ...
                    function parseFunction(response) {
                        ...
                        for (i = 0; i < arr.length; i++) {
                            out += "<li><a href=\"#1\"><img src=" + arr[i].Path + " width=\"160\" height=\"90\" alt=\"\"><strong>" + arr[i].Name + "</strong> $ Priceless</a></li>"

                        }
                        out += "</ul>";
                        document.getElementById("prod_nav").innerHTML = out;
                    }
                </script>
            </div>
            <!-- END navigator -->
